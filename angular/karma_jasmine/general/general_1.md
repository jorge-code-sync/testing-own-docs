...
1. [Guía rápida de Jasmine / Karma](#1-Guía-rápida-de-jasmine--karma)
...
## 1. Guía rápida de Jasmine / Karma
...
describe("UserService", () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      providers: [UserService, { provide: LoggerService, useValue: spy }],
    });
...
describe("TodoListComponent", () => {
  ...
  beforeEach(async () => {
    ...
    component = fixture.componentInstance;
    todoServiceMock = TestBed.inject(
      TodoService
...
describe("TodosResolver", () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      providers: [TodosResolver, { provide: TodoService, useValue: spy }],
    });
